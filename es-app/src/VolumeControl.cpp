...
VolumeControl::VolumeControl()
	...
	// macOS: no additional initialization needed
...
#if defined (__APPLE__)
	// macOS: Volume control not implemented
	LOG(LogWarning) << "VolumeControl::init() - Volume control not implemented for macOS";
#elif defined(__linux__)
...
#if defined (__APPLE__)
	// macOS: Return internal volume (not actual system volume)
...
#if defined (__APPLE__)
	// macOS: Volume stored internally but not applied to system
	// TODO: Implement CoreAudio volume control for macOS
#elif defined(__linux__)
	if (mixerElem != nullptr)
	{
		//get volume range
