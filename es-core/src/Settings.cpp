...
void Settings::setDefaults()
{
	...
	mStringMap["SlideshowScreenSaverBackgroundAudioFile"] = Utils::FileSystem::getHomePath() + "/.openconsole/slideshow/audio/slideshow_bg.wav";
	mBoolMap["SlideshowScreenSaverCustomMediaSource"] = false;
	mStringMap["SlideshowScreenSaverMediaDir"] = Utils::FileSystem::getHomePath() + "/.openconsole/slideshow/media";
...
void Settings::saveFile()
{
	...
	const std::string path = Utils::FileSystem::getHomePath() + "/.openconsole/es_settings.cfg";
